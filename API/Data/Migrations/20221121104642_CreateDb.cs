        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OldEdu = table.Column<string>(type: "TEXT", nullable: false),
                    ...
                    LvEdu = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Conpany = table.Column<string>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Histories_Jobs_JobId",
                        column: x => x.JobId,
                        principalTable: "Jobs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Histories_Students_StudentId1",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypePj = table.Column<string>(type: "TEXT", nullable: false),
                    ...
                    LinkWeb = table.Column<string>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Projects_Teachers_TeacherId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Histories_JobId",
                table: "Histories",
                column: "JobId");

            migrationBuilder.CreateIndex(
                name: "IX_Histories_StudentId1",
                table: "Histories",
                column: "StudentId1");
